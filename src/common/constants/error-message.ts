...
export const USER_ERROR_MESSAGES = {
  ...
  ADD_ITEM_TO_CART: 'Error in adding item to cart', // Message for errors during adding item to cart
  GET_CART_ITEMS: 'Error in fetching cart items', // Message for errors during fetching cart items
};
